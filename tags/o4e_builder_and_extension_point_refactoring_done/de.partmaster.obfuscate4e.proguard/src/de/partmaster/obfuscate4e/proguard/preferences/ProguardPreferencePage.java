package de.partmaster.obfuscate4e.proguard.preferences;
...
import de.partmaster.obfuscate4e.proguard.Activator;
import de.partmaster.obfuscate4e.proguard.ProguardConfigFileUpdater;
...
public class ProguardPreferencePage extends FieldEditorPreferencePage implements
	...
	public void createFieldEditors() {
		...
		Composite backupGroup = getGroupWrapper(groups, "Backup");
		...
		BooleanFieldEditor saveBackupField = new BooleanFieldEditor(
				PreferenceConstants.SAVE_PROGUARD_CONFIG_BACKUP,
				"When generating, save a &backup of "
						+ ProguardConfigFileUpdater.PROGUARD_CONFIG,
				backupGroup);

		addField(showDialogField);
		addField(saveBackupField);
